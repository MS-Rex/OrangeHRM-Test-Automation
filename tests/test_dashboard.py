...
class TestDashboard:
    ...
    def test_login_and_verify_dashboard(self, driver):
        ...
        # Assert
        assert dashboard_page.is_dashboard_loaded(), "Dashboard page not loaded after login"
    ...
    def test_navigate_to_my_leave(self, driver):
        ...
        # Assert
        assert leave_page.is_leave_page_loaded(), "Leave page not loaded after clicking My Leave"
        
        # Additional verifications for Leave page
        assert leave_page.is_displayed(leave_page.LEAVE_LIST), "Leave List section not displayed"
