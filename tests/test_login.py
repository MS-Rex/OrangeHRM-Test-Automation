...
class TestLogin:
    ...
    def test_invalid_credentials(self, driver):
        ...
        assert (
            "Invalid credentials" in login_page.get_error_message()
    ...
    def test_empty_username(self, driver):
        ...
        # Assert
        assert (
            login_page.is_username_validation_message_displayed()
        ), "Username validation message not displayed"
        assert (
            "Required" in login_page.get_username_validation_message()
    ...
    def test_empty_password(self, driver):
        ...
        # Assert
        assert (
            login_page.is_password_validation_message_displayed()
        ), "Password validation message not displayed"
        assert (
            "Required" in login_page.get_password_validation_message()
